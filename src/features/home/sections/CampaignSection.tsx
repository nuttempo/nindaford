...
import { useCampaigns } from "../hooks/usePromotion";
    ...
    <section ref={sectionRef}>
      ...
      <div className="flex flex-col gap-8">
        {campaigns.map((campaign) => {
          ...
          return (
            <Card key={campaign.id} className="p-6 md:p-8 shadow-sm ring-1 ring-slate-900/5 bg-white hover:shadow-lg hover:ring-slate-900/10 transition-all duration-300">
