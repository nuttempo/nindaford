    ...
    >
      <div className="relative">
        ...
        <div className="absolute left-3 top-3 right-3 flex items-start justify-between gap-2">
          <div className="rounded-2xl border border-white/20 bg-white/75 px-3 py-2 backdrop-blur-md shadow-sm">
          ...
          <div className="rounded-2xl border border-white/20 bg-[color:var(--c-primary)]/80 px-3 py-2 backdrop-blur-md shadow-sm text-white text-right">
